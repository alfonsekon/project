...
class Game:
    ...
    def get_available_pieces_and_moves(self) -> Dict[Tuple[int, int], List[Tuple[int, int]]]:
    ...
    def get_available_pieces_and_moves_opp(self) -> Dict[Tuple[int, int], List[Tuple[int, int]]]:
        opponent = "Player 1" if self.current_player == "Player 2" else "Player 2"
        all_moves: Dict[Tuple[int, int], List[Tuple[int, int]]] = {}
        for row in range(len(self.board.grid)):
            for col in range(len(self.board.grid[row])):
    ...
    def checkmate_opp(self):
        ...
        threatened_positions: Set[Tuple[int, int]] = set()
    ...
    def get_all_valid_moves_protected_pieces(self) -> Dict[str, Dict[Tuple[int, int], List[Tuple[int, int]]]]:
        protected_moves: Dict[str, Dict[Tuple[int, int], List[Tuple[int, int]]]] = {
            "Player 1": {},
            "Player 2": {}
        }
