...
from typing import TYPE_CHECKING, List, Tuple, Dict, Optional, cast
if TYPE_CHECKING: 
    from model.game import Game
...
class InputHandler:
    ...
    def handle_event(self, event: pygame.event.Event, game: "Game"):
        ...
        if event.type == pygame.MOUSEBUTTONDOWN and not game.game_over:
            ...
            grid_x, grid_y = (y - y_offset) // self.cell_size, (x - x_offset) // self.cell_size
            captured_piece_rects: Dict[str, List[Tuple[Piece, pygame.Rect]]] = game.renderer.render_captured_pieces(game.board)
            ...
            clicked_piece = cast(Piece, game.board.grid[grid_x][grid_y])
            ...
            if clicked_piece and clicked_piece.owner == game.current_player:
                ...
                self.orig_coords: Optional[Tuple[int, int]] = (grid_x, grid_y)
